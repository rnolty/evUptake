...
globalParameters = {
    'carTypes': {
        ...
        'midrange': {
            ...
            'depreciationCurve': {0: 1.0, 1: 0.7, 2: 0.6, 3: 0.5, 4: 0.42, 5: 0.36, 6: 0.3, 7: 0.25, 8: 0.18, 9: 0.1, 10: 0}'d'
        }
        'economy': {
            'initialValue': 15000,
            'depreciationCurve': {0: 1.0, 1: 0.7, 2: 0.6, 3: 0.5, 4: 0.42, 5: 0.36, 6: 0.3, 7: 0.25, 8: 0.18, 9: 0.1, 10: 0}
    ...
    'peopleGroups': [
        {'income': 10000, 'utilityFunction': peakedUtility(2000), 'fraction': 0.05}
        {'income': 20000, 'utilityFunction': peakedUtility(4000), 'fraction': 0.125}
        {'income': 30000, 'utilityFunction': peakedUtility(2000), 'fraction': 0.20}
        {'income': 40000, 'utilityFunction': peakedUtility(2000), 'fraction': 0.25}
        {'income': 60000, 'utilityFunction': peakedUtility(2000), 'fraction': 0.20}
        {'income': 80000, 'utilityFunction': peakedUtility(2000), 'fraction': 0.09}
        {'income': 100000, 'utilityFunction': peakedUtility(2000), 'fraction': 0.085}
    ]
}

from genericModel import initializeYear
import genericModel
genericModel.globalParameters = globalParameters

population, cars = initializeYear(population, cars)
